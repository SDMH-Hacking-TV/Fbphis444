...
echo ""
echo ""
echo -e "\e[91mGithub - https://github.com/SDMH-Hacking-TV \e[0m";
echo ""
echo -e "\e[95mFacebook - https://www.facebook.com/group/SDMH.Hacking.TV \e[0m";
echo -e "\e[94m# CODED BY ISURUWA\e[0m";
echo -e "";
cowsay -f tux CODED BY ISURUWA | lolcat -a
toilet -f mono12 -F gay "Thank"
